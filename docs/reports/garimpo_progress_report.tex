...
This report documents the second stage of a joint EMINES UM6P--UFAM three months research
...
Geoci\^encias (DEGEO), Federal University of Amazonas (UFAM). We thank
Prof.\ Naziano Pantoja Filizola and Mr.\ Adriano 
for the foundational thesis work this project builds upon.
...
\noindent
Monteiro, A.\ B.\ O.\ (2024).
\textit{Identifica\c{c}\~ao e an\'alise do garimpo de ouro no rio Madeira
atrav\'es do uso de imagens de radar e \'opticas relacionado aos aspectos
hidrodin\^amicos, geomorfol\'ogicos e geol\'ogicos}.
Trabalho Final de Gradua\c{c}\~ao (Bacharelado em Geologia),
Federal University of Amazonas, Manaus.
Available at:
\url{https://github.com/Fareshd049/Garimpo/blob/main/docs/reports/TFG%20-%20Anna%20Final.pdf}.

\noindent
\textit{CBERS-4A Satellite Data}.
Available at:
\url{https://www.kaggle.com/datasets/raraabdel/projet-ufam}.

\noindent
European Space Agency (ESA) / Copernicus.
\textit{Sentinel-1 and Sentinel-2 Satellite Data}.
Available at:
\url{https://www.kaggle.com/datasets/raraabdel/projet-ufam}.
...
For the **CBERS reference**, the current INPE portal is preferable to the old `cbers.inpe.br` URL you had before: it provides access to CBERS-4A products, including WPM data and the relevant product information.

For Sentinel, the Copernicus Data Space is the appropriate common entry point; its official pages document access to both Sentinel-1 and Sentinel-2 data.

If you send me **Anna's GitHub or PDF link**, I can put the exact URL into the LaTeX and give you the final version with **no placeholders**.
